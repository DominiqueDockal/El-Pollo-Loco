/**
 * Chicken enemy game object with walking animation and death mechanics
 * @class Chicken
 * @extends AnimatedGameObject
 * @description Represents a chicken enemy that walks left continuously and can be killed with death animation
 */
class Chicken extends AnimatedGameObject {
     ...
     * @description Initializes chicken with random walking speed, death mechanics, and hit detection
     */
